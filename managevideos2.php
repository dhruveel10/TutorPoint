			...
			<fieldset>
				...
				<form action="" method="POST" name="UpdateVideo">
					<table class="table table-hover">
						...
						<tr>
							<td><strong>Web Page URL </strong>
							</td>
							<td>
							<textarea name="V_Links" rows="5" cols="150"><?php $V_Links=$row['V_Links']; echo $V_Links;?></textarea>
							</td>
						</tr>							
						...
						<?php 
							...
							$V_Links = $_POST['V_Links'];
							$sql = "UPDATE `video` SET V_Title='$V_Title' , V_Url='$V_Url' , V_Remarks='$V_Remarks', V_Links='$V_Links' WHERE V_id=$make";
