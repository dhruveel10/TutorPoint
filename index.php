...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<h2 style="color: black; ">Start Learning</h2>
            </div>
            </div>
        </div>
        <!-- Controls -->
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
                    Welcome to TUTORPOINT CLASSROOMS
                </h1>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “TutorPoint Classrooms” Website (web based application) is useful for the
							students, guest whoever likes to learn from web using E-Learn
							(Videos) and find out list of fresh courses offered by us. It provides the facility to the students or guest to have complete
							information about the courses.It also helps the faculty as well as the admin to keep a track of the students and add new videos whenever they wish to. 
						</p>
					</li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<ul style="list-style-type:disc">
						...
						<li>To make the institute truly an E-learning institute.
						</li>
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="fa fa-fw fa-compass"></i>Project Category</h4>
				</div>
				<div class="panel-body">
					<p>
					<ul style="list-style-type:disc">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">COURSES AVAILABLE FOR LEARNING</h2>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">TUTORPOINT CLASSROOMS</h2>
		</div>
		<div class="col-md-6">
			<h4>The CLASSROOMS by <strong>TutorPoint</strong> includes the following courses:</h4>
			<ul>
