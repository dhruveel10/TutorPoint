...
<div class="container">
	<div class="row">
		...
		if ( isset( $_POST[ 'submit' ] ) ) {
			...
			$sql = "INSERT INTO `Video` (`V_Title`, `V_Url`, `V_Remarks`, `V_Links`) VALUES ('$title','$v_url','$v_info','$v_links')";
			...
			<fieldset>
				...
				<form action="" method="POST" name="AddAssessment">
					<table class="table table-hover">
						...
						<tr>
							<td><strong>Web Page URL</strong> </td>
							<td>
								<textarea name="V_Links" rows="5" cols="150"></textarea>
							</td>
						</tr>
